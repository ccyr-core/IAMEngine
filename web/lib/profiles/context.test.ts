...
//
// Same root cause as #0000108 on the offboard side, and the same shape as mirrorPermissionsFromUser
// (intake-mapper.ts:219), which has preferred the resolved email since #61.
