...
export const entry: ChangelogEntry = {
  ...
  date: "2026-09-23",
  time: "11:00",
  title: "Onboards: correct or remove the user the engine created (runner 1.137.0)",
  items: [
    ...
    "Users synced from AD are changed or removed in AD, and directory sync carries it to Microsoft 365. These steps only go to runners on 1.137.0 or later, and a correct or remove that needs AD is refused up front if the client's runner is older",
  ],
};
