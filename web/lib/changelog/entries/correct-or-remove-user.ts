...
export const entry: ChangelogEntry = {
  ...
  items: [
    ...
    "Users synced from AD are changed or removed in AD, and directory sync carries it to Microsoft 365. These steps only go to runners on 1.127.0 or later, and a correct or remove that needs AD is refused up front if the client's runner is older",
  ],
};
