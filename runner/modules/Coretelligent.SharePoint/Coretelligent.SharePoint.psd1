@{
    ...
    FunctionsToExport = @('Connect-CtgSharePointPnP', 'Get-CtgSharePointSiteUrls', 'Invoke-CtgSharePointSiteGroupsOffboard', 'Invoke-CtgSharePointSiteGroupsMirror', 'Grant-CtgSharePointSiteAccess', 'Get-CtgOneDriveSiteUrl', 'Test-CtgOffboardResolved', 'Invoke-CtgSharePointOffboardGrant', 'Test-CtgDelegateUnambiguous')
    CmdletsToExport   = @()
    VariablesToExport = @()
    AliasesToExport   = @()
}
