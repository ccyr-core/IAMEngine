@{
    ...
    FunctionsToExport = @('Connect-CtgGoogle', 'Invoke-CtgGoogleRemoveUser', 'Invoke-CtgGoogleCorrectUser', 'Get-CtgGoogleSessionScopes', 'Get-CtgGoogleCustomer', 'Invoke-CtgGoogleApi', 'Get-CtgGoogleUser', 'Get-CtgGoogleUserGroups', 'Invoke-CtgGoogleOnboarding', 'Invoke-CtgGoogleOffboarding', 'Confirm-CtgGoogle', 'Invoke-CtgGooglePasswordReset', 'Invoke-CtgGoogleChange', 'Invoke-CtgGoogleOAuthSignin', 'Invoke-CtgGoogleDwdGrant')
    CmdletsToExport   = @()
    VariablesToExport = @()
    AliasesToExport   = @()
}
